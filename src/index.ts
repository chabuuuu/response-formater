...
declare global {
  namespace Express {
    interface Response {
      ...
      send_insufficientSpaceOnResource: (
        message: string,
        content?: any
      ) => void;
      ...
      send_networkAuthenticationRequired: (
        message: string,
        content?: any
      ) => void;
      send_noContent: (message: string, content?: any) => void;
      send_nonAuthoritativeInformation: (
        message: string,
        content?: any
      ) => void;
      ...
      send_proxyAuthenticationRequired: (
        message: string,
        content?: any
      ) => void;
      send_requestHeaderFieldsTooLarge: (
        message: string,
        content?: any
      ) => void;
      ...
      send_requestedRangeNotSatisfiable: (
        message: string,
        content?: any
      ) => void;
...
const responser = (
  ...
  for (const [status, code] of Object.entries(HttpStatus)) {
    ...
    (response as any)["send_" + camelCase(status)] = function (
      message: string,
      content?: any
    ) {
      ...
      this.status(code).json({
        ...
        success,
        message,
        data: hasContent && success ? content : null,
        errors: hasContent && !success ? content : null,
      });
    };
  }
  next();
